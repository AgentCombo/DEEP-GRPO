...
# Epoch-local suffix-SFT ablation arm on Qwen2.5-Math-1.5B + MATH.
...
# ---- Teacher-token arm: epoch-local suffix SFT ----
...
export RUN_NAME=${RUN_NAME:-Qwen1.5B-MATH-pforest-SFT-${SUFFIX_SFT_SCHEDULE}-r${INJECTION_RATIO:-0.125}-${TIMESTAMP}}
